function [final_u_list,final_cost]=cooperation_measure(vi,vj,cost_list,u_list,n,n2,cost_full)
 ...
 indices=find(n_star*u_list'<b_ij);
 final_cost=cost_list(indices);
 final_u_list=u_list(indices,:);
end
